...
public class HttpUtils {
	...
	private static final Logger logger = LogUtils.getLinkLogger();
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String get(String url, String param, String charsetName,String refer) {
        StringBuilder result = new StringBuilder();
        BufferedReader in = null;
        try {
            String urlNameString = com.vista.utils.StringUtils.isEmpty(param)?url:url + "?" + param;
            ...
            connection.setRequestProperty("user-agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.71 Safari/537.1 LBBROWSER");
